namespace PiDev_GCommunity_GUI.Helpers
{
    public class CacheKeys
    {
        ...
        internal static readonly string AllChampionsByRegionKey = "AllChampions_{0}";
        internal static readonly string ChampionByRegionAndIdKey = "ChampionDtos/{0}{1}";
        internal static readonly string StaticChampionByRegionAndIdKey = "StaticChampionDtos/{0}{1}";
        internal static  string SummonerByRegionAndIdCacheKey = "SummonerById_{0}_{1}";
